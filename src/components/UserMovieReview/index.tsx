...
const UserMovieReview: React.FC<UserMovieReviewProps> = ({ preview }) => {
  ...
  return (
    <div className="mt-4">
      <div
        className={clsx(
          'flex flex-col gap-2 py-4 border-b border-b-grey-300 first:pt-0',
          {
      ...
      >
        ...
        <p className="text-grey-200">
          Pretty similar to how I feel about the Brockhampton documentary. As a
          Travis Scott fan, I dug it, but thats only really because Im familiar
          with him, his performances, his music, and this is just a closer look
          at all of that. If youre going into this knowing nothing, youll come
          away knowing about the same and probably even a little turned off by
          how up his own ass Travis comes across through this. Unlike
          Brockhamptons doc, this had barely any structure to it and doesnt
          really give you anything to get hooked on. Which sucks because it
          makes it pretty clear that Travis is a pretty interesting guy with an
          interesting story but it just kinda...doesnt do anything with that.
          Cant believe I just wrote a serious review for a Travis Scott Netflix
          documentary lol.
        </p>
