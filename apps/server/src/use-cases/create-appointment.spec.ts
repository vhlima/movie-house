...
import { InMemoryAppointmentsRepository } from '../repositories/tests/in-memory/in-memory-appointments-repository';
...
describe('Create Appointment', () => {
  ...
  it('should not be to create an appointment with overlapping dates', async () => {
    const appointmentsRepository = new InMemoryAppointmentsRepository();
